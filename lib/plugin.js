...
// Generating a random namespace prefix to store values on an object without colliding with existing properties.
// Should be enough randomness for our use-case.
var namespacePrefix = Math.random().toString();
 ...
 */
function plugin(fn) {
    var namespace = namespacePrefix + nextNamespaceId++;
