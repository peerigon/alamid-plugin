...
/**
 * Returns true if the property `key` is defined on `obj`. Takes the whole prototype chain into account
 * and even recognizes properties that are not enumerable.
 *
 * @private
 * @param {object} obj
 * @param {string} key
...
/**
 * Check if any object in the prototype chain has an own property called `key`.
 *
 * @private
 * @param {object} obj
 * @param {string} key
